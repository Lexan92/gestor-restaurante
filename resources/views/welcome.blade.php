    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-normal text-2xl">Web Administrativa</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Pagina Web Administrativa de Restaurante Capriccio
                </p>


            </div>
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] flex items-center justify-center relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                <img src="{{ asset('images/logo.png') }}" alt="Descripción de la imagen"
